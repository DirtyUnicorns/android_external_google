...
public class DockContract {
    ...
    public static final Uri DOCK_PROVIDER_CONNECTED_URI = new Builder().scheme("content").authority("com.google.android.apps.dreamliner.provider").appendPath("connected").build();
    @VisibleForTesting
    static final int DOCK_PROVIDER_SAVED_TOKEN = 2;
    public static final Uri DOCK_PROVIDER_SAVED_URI = new Builder().scheme("content").authority("com.google.android.apps.dreamliner.provider").appendPath("saved").build();
