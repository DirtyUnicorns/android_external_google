...
public final class DockInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.manufacturer, other.manufacturer) && HidlSupport.deepEquals(this.model, other.model) && HidlSupport.deepEquals(this.serial, other.serial) && this.maxFwSize == other.maxFwSize && this.isGetInfoSupported == other.isGetInfoSupported && HidlSupport.deepEquals(this.version, other.version) && this.orientation == other.orientation && this.type == other.type) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer((long) (this.manufacturer.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 0) + 0, false);
        this.model = hwBlob.getString(_hidl_offset + 16);
        parcel.readEmbeddedBuffer((long) (this.model.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 16) + 0, false);
        this.serial = hwBlob.getString(_hidl_offset + 32);
        parcel.readEmbeddedBuffer((long) (this.serial.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 32) + 0, false);
